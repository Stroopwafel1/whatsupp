...
public class ChatActivity extends AppCompatActivity {
    ...
    private void IntializeControllers() {
        ...
        ChatToolBar = findViewById(R.id.private_chat_bar_layout);
        ...
        SendMessageButton = findViewById(R.id.private_send_messsage_button);
        MessageInputText = findViewById(R.id.input_private_message);

        messageAdapter = new MessageAdapter(messagesList);
        userMessagesList = findViewById(R.id.private_message_list_of);
